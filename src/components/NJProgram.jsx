...
import {
  ...
  NJInpersonProgramDetails,
  NJOngoingProgramDetails,
} from "../ProgramDetails";
  ...
  return (
    <div className="outer-box">
      ...
      <div className="prog-head">
        {NJInpersonProgramDetails.map(createInPersonProgram)}
      </div>
      <div className="prog-top">
        <div className="prog-title color-title">
          <p>Online Programs</p>
      ...
      <div className="prog-head">
        {NJOngoingProgramDetails.map(createProgram)}
      </div>
      {/* <div className="prog-top">
        <div className="prog-title color-title">
